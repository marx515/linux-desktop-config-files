...
-- Cursor settings
vim.opt.guicursor = "n-v:block,i-c-ci-ve:ver100,r-cr:hor20,o:hor50,a:blinkwait700-blinkoff400-blinkon250-Cursor/lCursor,sm:block-blinkwait175-blinkoff150-blinkon175"
...
local function mode_icon()
  ...
  local modes = {
    n = "NORMAL",      -- nf-fa-pencil
    i = "INSERT",      -- nf-linux-vim
    v = "VISUAL",      -- nf-fa-eye
    V = "V-LINE",
    ["\22"] = "V-BLOCK",  -- Ctrl-V
    c = "COMMAND",     -- nf-fa-terminal
    s = "SELECT",      -- nf-fa-files_o
    S = "S-LINE",
    ["\19"] = "S-BLOCK",  -- Ctrl-S
    R = "REPLACE",     -- nf-fa-edit
    r = "REPLACE",
    ["!"] = "SHELL",   -- nf-oct-terminal
    t = "TERMINAL"     -- nf-fa-terminal
  }
...
local function setup_dynamic_statusline()
  vim.api.nvim_create_autocmd({"WinEnter", "BufEnter"}, {
    ...
    vim.opt_local.statusline = table.concat {
      "%#StatusLineBold#", -- Bold text
      "  %{v:lua.mode_icon()}",
      "%#StatusLine#", -- Normal text
      "  %f",   -- File path
      "  %{v:lua.git_branch()}",
      "  %{v:lua.file_size()}",
      "%=",     -- Right-align everything after this
      "%l:%c  %P  ",    -- Line/col and percentage
    }
    end
  })
